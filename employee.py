...
class Employee:
    ...
    def get_pay(self):
        return self.calculate_total_pay() + self.get_commision_value()
    
    def calculate_total_pay(self):
        return 0
    
    def get_commision_value(self):
        if self.commission:
            return self.commission.get_value()
        else:
            return 0
...
class CommissionContract:
    def __init__(self, contract_num, price_per_contract):
...
renee = SalaryEmployee("Renee", 3000, CommissionContract(4, 200))

# Jan works on a contract of 150 hours at 25/hour and receives a commission for 3 contract(s) at 220/contract.  Their total pay is 4410.
jan = HourlyEmployee("Jan", 150, 25, CommissionContract(3, 220))

# Robbie works on a monthly salary of 2000 and receives a bonus commission of 1500.  Their total pay is 3500.
robbie = SalaryEmployee("Robbie", 2000, CommissionFixed(1500))

# Ariel works on a contract of 120 hours at 30/hour and receives a bonus commission of 600.  Their total pay is 4200.
ariel = HourlyEmployee("Ariel", 120, 30, CommissionFixed(600))